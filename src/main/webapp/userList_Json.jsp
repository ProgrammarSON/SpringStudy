...
<script type="text/javascript" >
	...
	function userDelete() {
		//삭제 버튼 클릭
		$('body').on('click','#btnDelete',function(){	//위임형
	...
	function userListResult(data) {
		...
		$.each(data,function(idx,item){
			...
			.appendTo('tbody');	//자식 태그를 tbody에 붙인다
		});//each
	}//userListResult
</script>
</head>
		...
		<div class="form-group">   
			<label>역할:</label>
				<select class="form-control" name="role">
					   		...
					   		<option value="buha">부하</option>
					   		<option value="deri">대리</option>
					   		<option value="jang">팀장</option>
					   		<option value="buha">말단</option>
					   		<option value="admin">최종</option>
				</select>
		</div>  
		<div class="btn-group">      
